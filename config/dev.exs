...
config :elixir_api_db, ElixirApiDbWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "Rh/bJtiPmmt567o+xv+aPTJEV4ImdxQd32LaOPYjm1QLUfn65KTOcrgWOYsql4Jk",
  watchers: [
...
config :elixir_api_db, ElixirApiDbWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/elixir_api_db_web/(live|views)/.*(ex)$",
      ~r"lib/elixir_api_db_web/templates/.*(eex)$"
    ]
  ]
